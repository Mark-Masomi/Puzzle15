...
public class CustomFonts {
   ...
   //public static Font dialog_Input = new Font(Font.DIALOG, Font.PLAIN,  static_variables.CustomSizes.button_size);
   //-------------------------------------------------------------------------------------------------------------------
   ...
   public static Font monospace_Button = new Font   (Font.MONOSPACED, Font.BOLD,  CustomSizes.button_size);
